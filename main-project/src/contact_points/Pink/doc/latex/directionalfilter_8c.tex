\doxysection{directionalfilter.\+c File Reference}
...
{\bfseries{Usage\+:}} \doxyref{directionalfilter.\+c}{p.}{directionalfilter_8c} in.\+pgm width length ndir out.\+pgm
...
\begin{DoxyVerb}sigma = 1 / (2*width*width);
