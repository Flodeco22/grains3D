\doxysection{explodecomp.\+c File Reference}
...
{\bfseries{Usage\+:}} explodecomp in.\+pgm connex \{min$\vert$max$\vert$pla\} name\+\_\+prefix

{\bfseries{Description\+:}} Generated file names are of the form\+: {\bfseries{name\+\_\+prefix}}nnnn.\+pgm, where nnnn is a four digit decimal integer. The argument {\bfseries{connex}} selects the connectivity (4, 8 in 2D; 6, 18, 26 in 3D). The argument {\bfseries{$<$min$\vert$max$\vert$pla$>$}} selects the kind of flat zone to be labeled\+: \begin{DoxyItemize}
