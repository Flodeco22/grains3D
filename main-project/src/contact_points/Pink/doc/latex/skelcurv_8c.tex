\doxysection{skelcurv.\+c File Reference}
...
{\bfseries{Usage\+:}} skelcurv in.\+pgm prio connex [inhibit] out.\+pgm

{\bfseries{Description\+:}} Curvilinear binary skeleton guided by a priority image. The lowest values of the priority image correspond to the highest priority. Isthmuses are dynamically detected and added as control points.
...
\item 0\+: approximate euclidean distance \item 1\+: approximate quadratic euclidean distance \item 2\+: chamfer distance \item 3\+: exact quadratic euclidean distance \item 4\+: 4-\/distance in 2d \item 8\+: 8-\/distance in 2d \item 6\+: 6-\/distance in 3d \item 18\+: 18-\/distance in 3d \item 26\+: 26-\/distance in 3d \item 5\+: breadth-\/first and directional strategy \item 7\+: breadth-\/first naive strategy\end{DoxyItemize}
...
where T(y) refers to the connectivity number of y, that is, (informally) the number of connected components of gamma(y) inter (X \textbackslash{} \{y\}).
...
Michel Couprie
\end{DoxyAuthor}
{\bfseries{Usage\+:}} skelcurv2 in.\+pgm prio connex param [inhibit] out.\+pgm
