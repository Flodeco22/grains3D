\doxysection{watershedthin.\+c File Reference}
\label{watershedthin_8c}\index{watershedthin.c@{watershedthin.c}}


Thin watershed transformation (Meyer\textquotesingle{}s algorithm on perfect fusion grid)  
...
{\bfseries{Usage\+:}} watershedthin in mark \{bgmark$\vert$null\} \{roi$\vert$null\} parite out
