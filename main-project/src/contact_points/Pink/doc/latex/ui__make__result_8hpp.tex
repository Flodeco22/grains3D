\doxysection{ui\+\_\+make\+\_\+result.\+hpp File Reference}
\label{ui__make__result_8hpp}\index{ui\_make\_result.hpp@{ui\_make\_result.hpp}}


This is a helper function for exporting Pink C functions in Python. Note that this template file is rarely used directly and is called by the UI\+\_\+\+WRAP\+\_\+\+RESULT macro.  
...
\DoxyCodeLine{\ \ \&make\_result<result\_type,\ image\_type,\ T1,\ T2,\ ...,\ Tn,\ \&pink\_c\_function>,}
...
make\+\_\+result is a template. In the first parameter you specify the result image type. Second, you specify the input image type. Thirds you specify the types of the parameters and last you put the pointer to your Pink function.
...
\DoxyCodeLine{\ \ \ \ \ \&make\_result<int\_image,\ char\_image,\ int,\ \&lptisolated>,}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{template}\ <\ \textcolor{keyword}{class\ }result\_type,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{class\ }image\_type,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ int\ (*mcfunction)\ (}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ convert\_if<image\_type>::type,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ convert\_if<result\_type>::type}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ >}
\DoxyCodeLine{result\_type\ make\_result(\ image\_type\ image\ )}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ result\_type\ result(image.get\_size());}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{if}\ (!mcfunction(image,\ result))\ \{\ \{}
\DoxyCodeLine{\ \ \ \ \ \ std::stringstream\ fullmessage;}
\DoxyCodeLine{\ \ \ \ \ \ fullmessage\ <<\ \textcolor{stringliteral}{"{}in\ ui\_make\_result.hpp:\ "{}}\ <<\ \textcolor{stringliteral}{"{}mcfunction\ failed"{}};}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ convert\_if<result\_type>::type\ )}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ >}
\DoxyCodeLine{result\_type\ make\_result(\ image\_type\ image\ ,\ T0\ t0\ )}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ result\_type\ result(image.get\_size());}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{if}\ (!mcfunction(image,\ t0\ ,\ result))\ \{\ \{}
\DoxyCodeLine{\ \ \ \ \ \ std::stringstream\ fullmessage;}
\DoxyCodeLine{\ \ \ \ \ \ fullmessage\ <<\ \textcolor{stringliteral}{"{}in\ ui\_make\_result.hpp:\ "{}}\ <<\ \textcolor{stringliteral}{"{}mcfunction\ failed"{}};}
\DoxyCodeLine{\ \ \ \ \ \ call\_error(fullmessage.str());}
\DoxyCodeLine{\ \ \ \ \};}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{class\ }result\_type,}
\DoxyCodeLine{\ \ \textcolor{keyword}{class\ }image\_type,}
\DoxyCodeLine{\ \ \textcolor{keyword}{class\ }T0\ ,}
...
\DoxyCodeLine{\ \ \ \ )}
\DoxyCodeLine{\ \ >}
\DoxyCodeLine{result\_type\ make\_result(\ image\_type\ image\ ,\ T0\ t0\ ,\ T1\ t1\ )}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ result\_type\ result(image.get\_size());}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{if}\ (!mcfunction(image,\ t0\ ,\ t1\ ,\ result))\ \{\ \{}
\DoxyCodeLine{\ \ \ \ \ \ std::stringstream\ fullmessage;}
\DoxyCodeLine{\ \ \ \ \ \ fullmessage\ <<\ \textcolor{stringliteral}{"{}in\ ui\_make\_result.hpp:\ "{}}\ <<\ \textcolor{stringliteral}{"{}mcfunction\ failed"{}};}
\DoxyCodeLine{\ \ \ \ \ \ call\_error(fullmessage.str());}
\DoxyCodeLine{\ \ \ \ \};}
