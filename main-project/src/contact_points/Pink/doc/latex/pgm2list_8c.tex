\doxysection{pgm2list.\+c File Reference}
...
{\bfseries{Usage\+:}} pgm2list image.\+pgm \{e$\vert$s$\vert$b$\vert$n$\vert$\+B$\vert$N\} out.\+list
...
\end{DoxyPre}
 $<$B~\newline
$>$Types supported\+: byte 2D, byte 3D, int32\+\_\+t 2D, int32\+\_\+t 3D, float 2D, float 3D
