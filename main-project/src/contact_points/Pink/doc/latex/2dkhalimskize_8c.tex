\doxysection{2dkhalimskize.\+c File Reference}
...
{\bfseries{Usage\+:}} 2dkhalimskize in.\+pgm \{0$\vert$4$\vert$8$\vert$h$\vert$m$\vert$\+M$\vert$g$\vert$\+G$\vert$a\} out.\+pgm
...
\item 0 \+: only maximal elements, \item 4 \+: emulates 4-\/connectivity, idem "{}miss"{}, \item 8 \+: emulates 8-\/connectivity ("{}hit"{} transform followed by a kernel transform), ~\newline
 \item h \+: "{}hit"{}, \item m \+: min, \item M \+: max, \item g \+: gradient 2, \item G \+: gradient 4, \item a \+: average, \item R \+: reverse.\end{DoxyItemize}
