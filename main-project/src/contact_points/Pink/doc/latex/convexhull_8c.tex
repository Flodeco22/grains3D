\doxysection{convexhull.\+c File Reference}
...
{\bfseries{Usage\+:}} convewhull in.\+pgm mode out

{\bfseries{Description\+:}} Computes the convex hull of the set of non-\/null points in the image {\bfseries{in.\+pgm}}, by the Jarvis\textquotesingle{}s algorithm as described in "{}\+Introduction to algorithms"{}, T. Cormen, C. Leiserson, R. Rivest, MIT Press.
