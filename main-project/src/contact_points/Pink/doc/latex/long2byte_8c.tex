\doxysection{long2byte.\+c File Reference}
\label{long2byte_8c}\index{long2byte.c@{long2byte.c}}


converts a "{}int32\+\_\+t"{} image to a "{}byte"{} image  
...
converts a "{}int32\+\_\+t"{} image to a "{}ushort"{} image

{\bfseries{Usage\+:}} long2byte in.\+pgm [mode] [n] out.\+pgm
...
Michel Couprie
\end{DoxyAuthor}
{\bfseries{Usage\+:}} long2byte in.\+pgm [mode] out.\+pgm

{\bfseries{Description\+:}}

Depending on the value given for the (optional) parameter {\bfseries{mode}}\+: \begin{DoxyItemize}
\item {\bfseries{mode}} = 0 (default) \+: for all x, out[x] = min(\+USHRT\+\_\+\+MAX, in[x]). \item {\bfseries{mode}} = 1 \+: for all x, out[x] = in[x] modulo USHRT\+\_\+\+MAX. \item {\bfseries{mode}} = 2 \+: scales values in the range 0-\/USHRT\+\_\+\+MAX. \item {\bfseries{mode}} = 4 \+: truncation of the square root in the range 0-\/255. \item {\bfseries{mode}} = 5 \+: truncation of the log in the range 0-\/255.\end{DoxyItemize}
{\bfseries{Types supported\+:}} short\+\_\+image (any D)
